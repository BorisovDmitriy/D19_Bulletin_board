...
#Создаем группу
common_group =Group.objects.get_or_create(name='common')
add_ads = Permission.objects.get(name='Can add Объявление')
common_group.permissions.add(add_ads)
add_response = Permission.objects.get(name='Can add Отклики')
common_group.permissions.add(add_response)
change_ad = Permission.objects.get('Can change Объявление')
common_group.permissions.add(change_ad)
change_response = Permission.objects.get('Can change Отклики')
common_group.permissions.add(change_response)
delete_ad = Permission.objects.get('Can delete Объявление')
common_group.permissions.add(delete_ad)
delete_response = Permission.objects.get('Can delete Отклики')
common_group.permissions.add(delete_response)
